...
//              return 0;
          ...
          env->ReleaseStringUTFChars(dupa,nativedupa);
                                                    ...
                                                    JNIEnv* env, jobject obj)
{
    ...
    for (int i=0; i<NUM_TARGETS; i++)
    {
        ...
        keyframeQuadAspectRatio[i] = (float)textures[0]->mHeight / (float)textures[0]->mWidth;
    }
